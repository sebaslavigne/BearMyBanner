namespace BearMyBanner.Settings
{
    public class MCMDisplayName
    {
        ...
        public const string DropOnLowHealth = "Drop banners when health is low";
        public const string DropHealthThreshold = "Health threshold";
        public const string DropHealthThresholdFormat = "0 HP";
        public const string DropRetreatModeSetting = "Drop banners when retreating";
        public const string DropRetreatModeDisabled = "Disabled";
        public const string DropRetreatModeWeighted = "Weighted by experience";
        public const string DropRetreatModeFixed = "Fixed chance";
